            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    {testimonials.map((t, i) => (
                        <div key={i} className="bg-white/50 border border-white/60 backdrop-blur-md rounded-2xl hover:bg-white/70 hover:shadow-md p-6 transition-all flex flex-col gap-4">
