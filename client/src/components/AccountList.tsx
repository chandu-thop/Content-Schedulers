    ...
    if(accounts.length===0){
        return (
            ...
            flex flex-col items-center justify-center py-20 px-6">
                ...
                justify-center mb-4 border-slate-100">
                    <PlusIcon className="size-6 text-slate-500 opacity-50"/>
                </div>
                <p className="text-slate-700 text-lg">No accounts connected</p>
                <p className="text-sm text-slate-400 mt-1 max-w-xs text-center">Connect your first social platform to start scheduling and automating
                    your content.
                </p>
            ...
            return(
                ...
                transition-all">
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                        ...
                        title="Disconnect Account" className="ml-2 p-1.5 rounded-lg text-slate-300 hover:text-red-500 transition-all">
